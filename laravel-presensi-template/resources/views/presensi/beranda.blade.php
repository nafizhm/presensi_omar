...
<div class="px-5 text-[13px] text-ink-soft mb-4">{{ now()->translatedFormat('l, d F Y') }}</div>
...
{{-- Weekly stats --}}
<div class="px-5 mt-5">
    <div class="font-display text-[14px] font-semibold text-ink mb-3">Ringkasan {{ now()->translatedFormat('F Y') }}</div>
